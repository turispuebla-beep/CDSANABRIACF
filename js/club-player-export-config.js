...
(function (global) {
  ...
  const FIELD_CATALOG = [
    ...
    { id: 'consent_normas', label: 'Normas inscripción', defaultEnabled: true, group: 'otros' },
    { id: 'consent_jugador', label: 'Consent. jugador', defaultEnabled: true, group: 'otros' },
    { id: 'consent_imagen', label: 'Consent. imagen', defaultEnabled: true, group: 'otros' },
    { id: 'consent_categoria_superior', label: 'Autor. categoría superior', defaultEnabled: true, group: 'otros' },
